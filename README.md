...
Follow the instructions on [UCL installation and running](images/Install.md)

## Timetable

[class timetable for 2020/21](images/TIMETABLE.md)
...
follow the instructions on [UCL installation and running](images/Install.md). If you are running from outside UCL [see these notes](images/OutsideInstall-Local.md).
