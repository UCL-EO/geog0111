...
follow the instructions on [UCL installation and running](notebooks/Install.md). If you are running from outside UCL [see these notes](notebooks/OutsideInstall-Local.md), or if you want to run the notebooks using [docker](https://www.docker.com) [these notes](notebooks/OutsideInstall-Docker.md).
