# 032 GDAL: mosaicing and masking
...
* how to do [`numpy` slicing](031_Numpy.md#slicing) and numpy functions to get [array statistics](031_Numpy.md#Summary-statistics)
...
```
    ...
    --> retrieving query https://e4ftl01.cr.usgs.gov/MOTA/MCD15A3H.006/2019.02.10/MCD15A3H*.h17v03*.hdf from database
    --> retrieving data https://e4ftl01.cr.usgs.gov/MOTA/MCD15A3H.006/2019.02.10/MCD15A3H.A2019041.h17v03.006.2019050221756.hdf from database
    --> local file /shared/groups/jrole001/geog0111/work/e4ftl01.cr.usgs.gov/MOTA/MCD15A3H.006/2019.02.10/MCD15A3H.A2019041.h17v03.006.2019050221756.hdf.store exists
...
You will need to recall how to filter and [mask `numpy` arrays](026_Numpy.md#argmin,-argmax-and-masking) and use [`np.where`](026_Numpy.md#where).
...
```
    ...
    <matplotlib.colorbar.Colorbar at 0x7fee62fc6750>




![png](032_GDAL_mosaicing_and_masking_files/032_GDAL_mosaicing_and_masking_14_1.png)
...
We have seen in [026 Numpy](026_Numpy.md) how we can use the idea of slicing to sub-set an array:
...
We can use standard [`numpy` slicing](026_Numpy.md#slicing) to sub-set then:
...
![png](032_GDAL_mosaicing_and_masking_files/032_GDAL_mosaicing_and_masking_17_1.png)
...
![png](032_GDAL_mosaicing_and_masking_files/032_GDAL_mosaicing_and_masking_19_1.png)
...
```
    ...
    <matplotlib.colorbar.Colorbar at 0x7fee63413f50>




![png](032_GDAL_mosaicing_and_masking_files/032_GDAL_mosaicing_and_masking_22_1.png)
...
```
    ...
    <matplotlib.colorbar.Colorbar at 0x7fee618c3390>




![png](032_GDAL_mosaicing_and_masking_files/032_GDAL_mosaicing_and_masking_27_1.png)
